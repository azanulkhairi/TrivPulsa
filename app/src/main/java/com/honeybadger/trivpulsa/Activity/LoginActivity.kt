...
import com.honeybadger.trivpulsa.services.ServiceInterface
   ...
   // private var mAuthTask: UserLoginTask? = null
    ...
    fun loginUser() {
        ...
        if (TextUtils.isEmpty(Email)){
            ...
            var userLogin = LoginPayload(Email, Password)
            var userCall :Call<User> = serviceApi.doLogin(userLogin);
